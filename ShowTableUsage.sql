...
CREATE procedure ShowTableUsage (
...
*****************************************************************************************************************************************************************/
	...
	select @Version = 
		case
			when (select left(@@VERSION,30)) like '%2012%' then '2012'
			when (select left(@@VERSION,30)) like '%2013%' then '2013'
	...
	if @Version in ('2012','2019','2022','2025','SQL Azure') or cast(@Version as int) > 2025 begin 
